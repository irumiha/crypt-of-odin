...
| `src/tilemap.odin` | changed | testability refactor: `parse_map(ascii)` no longer touches the atlas; looks moved into `Tile_Skin`/`make_skin`; floor variants `FLOOR_VARIANTS :: 4` (was 8, matching the typed atlas's 4 floor strips) |
