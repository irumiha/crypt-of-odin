...
| `src/main.odin` | changed | text HUD replaced by `draw_hud`; damage numbers spawned from events (velocity + lifetime reuse the existing systems); two-pass rendering |
