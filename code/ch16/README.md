...
| `src/main.odin` | changed | `.Victory` phase, boss wiring (lock-in, roar, minion cap by throne-room census, death ceremony), ring drawn with the Chapter 1 primitives, victory screen, `counted` plurals |
